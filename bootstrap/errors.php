...
return function($request, $response) {
	...
	$this
		 ...
		 * @return string
		 */
		->addMethod('errorHtml', function(Exception $error, $detail = false) {
		 ...
		 * @return string
		 */
		->addMethod('errorJson', function(Exception $error, $detail = false) {
			$message = 'A Server Error occurred';
		 ...
		 * @return string
		 */
		->addMethod('errorText', function(Exception $error, $detail = false) {
			$message = 'A Server Error occurred';
